...
public class CadastroModeloCarroBean implements Serializable {
	...
	private List<TipoCombustivel> tipoCombustiveis;
	...
	public void inicializar() {
		this.limpar();
		this.fabricantes = fabricanteDAO.buscarTodosFabricantes();
		this.categorias = Arrays.asList(Categoria.values());
		this.tipoCombustiveis = Arrays.asList(TipoCombustivel.values());
	}
